...
private:
	...
	DWORD GAMEPAD_RIGHT_THUMB_UP_1 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_UP_2 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_UP_3 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_UP_4 = NULL;

	DWORD GAMEPAD_RIGHT_THUMB_DOWN_1 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_DOWN_2 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_DOWN_3 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_DOWN_4 = NULL;

	DWORD GAMEPAD_RIGHT_THUMB_LEFT_1 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_LEFT_2 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_LEFT_3 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_LEFT_4 = NULL;

	DWORD GAMEPAD_RIGHT_THUMB_RIGHT_1 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_RIGHT_2 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_RIGHT_3 = NULL;
	DWORD GAMEPAD_RIGHT_THUMB_RIGHT_4 = NULL;

	DWORD GAMEPAD_RIGHT_THUMB_RESET = NULL;
